...
DATABASES = {
    "default": {
        ...
        "NAME": config("DB_NAME", default=config("MYSQL_DATABASE", default="billing")),
        "USER": config("DB_USER", default=config("MYSQL_USER", default="root")),
        "PASSWORD": config("DB_PASSWORD", default=config("MYSQL_PASSWORD", default="")),
        "HOST": config("DB_HOST", default=config("MYSQL_HOST", default="localhost")),
        "PORT": config("DB_PORT", default=config("MYSQL_PORT", default="5432")),
    }
}
...
# ── Supabase (optional — used by billing_api app) ────────────────────────────
